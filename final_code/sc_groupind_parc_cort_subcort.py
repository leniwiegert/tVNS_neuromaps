...
to the same data as parcellated subcortical maps. These steps are performed on group and individual level.
'''
...
for i, brain_map in enumerate(brain_maps):
    ...
    plt.plot(x_values, [corr_values_mean_cortical[i], corr_values_mean_subcortical[i]], marker='o', linestyle='-',
